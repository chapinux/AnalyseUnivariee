...
On normalise parfois en considérant $K'=K-3$ (excès d'aplatissement)
...
```{r boxplot_code_1, echo=T, fig.height=3, fig.width=8, warning=FALSE, cache=FALSE}
library(palmerpenguins)
data(package = 'palmerpenguins')
mydata <-  penguins
...
Appliquer une transformation **monotone**, **bijective** et **inversible** qui "aplatisse" la distribution.
