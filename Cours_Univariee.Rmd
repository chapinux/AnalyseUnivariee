...
## Avertissement  {.flexbox .vcenter}
 ...
 <span style="color:red">&#9888;</span>  Pour voir les formules mathématiques des diapos, une connexion internet est requise.  <span style="color:red">&#9888;</span> 
...
*«déceler en quoi la localisation apporte un élément utile à la connaissances des objets étudiés et peut en expliquer les caractéristiques»* </div>
...
<span style="text-decoration: underline;
  text-decoration-color: #96C31E;">Analyse statistique :</span> 

Des méthodes résumant (statistique descriptive) et généralisant des observations

* Les unités d’analyse sont des éléments indépendants en principe 
* On ne s’intéresse pas à leur localisation
* On ne tient pas compte de leur interaction
...
<div style="margin: 10px;">Analyse de données  : 
...
plot1 <- ggplot(X)+
        ...
        annotate("text", x=c(1.5,2.5), y=c(0.3,0.12), colour=c("red","blue"),label=c("  68,27%\n de l'effectif ","95,45%\n de l'effectif "))+
        theme_light()
plot1
```
