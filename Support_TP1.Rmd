---
title: "TP1 Analyse Univariée"
subtitle: "M2 IGAST 2019-2020"
author: ""
date: ""
output: 
  pdf_document :
...
Les manipulations peuvent être effectuées avec PostGIS, QGIS et  R .
Il est théoriquement possible de réaliser les traitements statistiques avec MS Excel, mais il est fortement recommandé d'utiliser R, langage dans lequel sera donné le corrigé.
...
Étapes :
  ...
  - Calculer les indicateurs de formes des distributions de ces deux variables 
...
Etapes : 
  ...
  - Réaliser une classification des densités en faisant varier la méthode de classification
  - Cartographier la classification qui semble la plus adaptée 
